...
\mbox{}\verb@#'For multinomial data, the implementation is curerntly written in R, so it is not very fast.@\\
\mbox{}\verb@#'@\\
\mbox{}\verb@#'@{\tt @}\verb@examples@\\
\mbox{}\verb@#'data(dehp)@\\
...
\mbox{}\verb@   @\\
\mbox{}\verb@    res <- mc.est.raw(object=object, eps=eps, ...)@\\
...
\mbox{}\verb@@\\
\mbox{}\verb@#'@{\tt @}\verb@rdname CorrBin-internal@\\
\mbox{}\verb@mc.est.raw <- function(object, ...) UseMethod("mc.est.raw")@\\
\mbox{}\verb@@\\
\mbox{}\verb@#'@{\tt @}\verb@method mc.est.raw CMData@\\
\mbox{}\verb@mc.est.raw.CMData <- function(object, eps=1E-6, ...){@\\
