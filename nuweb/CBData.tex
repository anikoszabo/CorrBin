...
\NWtarget{nuweb?}{} \verb@"../R/CorrBin-package.R"@\nobreak\ {\footnotesize {?}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@#'Nonparameterics for Correlated Binary and Multinomial Data@\\
\mbox{}\verb@#'@\\
\mbox{}\verb@#'This package implements nonparametric methods for analysing exchangeable@\\
...
\mbox{}\verb@#'@\\
\mbox{}\verb@#'\tabular{ll}{ @\\
\mbox{}\verb@#' Package: \tab CorrBin\cr @\\
\mbox{}\verb@#' Type: \tab Package\cr @\\
\mbox{}\verb@#' Version: \tab 1.5\cr@\\
\mbox{}\verb@#' Date: \tab 2014-12-18\cr @\\
\mbox{}\verb@#' License: \tab GPL 2\cr @\\
\mbox{}\verb@#' LazyLoad: \tab yes\cr@\\
\mbox{}\verb@#'} @\\
...
\mbox{}\verb@#'@{\tt @}\verb@param ... additonal arguments passed to \code{\link[utils]{read.table}}@\\
