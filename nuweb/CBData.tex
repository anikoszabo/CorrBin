...
\mbox{}\verb@#'the \code{geepack} library, which is required for this feature to work.@\\
...
\mbox{}\verb@  if (!requireNamespace("geepack", quietly = TRUE)) {@\\
\mbox{}\verb@        stop("Please install geepack: install.packages('geepack')")@\\
\mbox{}\verb@        }@\\
\mbox{}\verb@  ucb <- unwrap.CBData(cbdata)@\\
\mbox{}\verb@  scale.method <- match.arg(scale.method)@\\
\mbox{}\verb@  if (scale.method=="fixed") {@\\
\mbox{}\verb@    geemod <- geepack::geese(Resp~unclass(Trt), id=ucb$ID, scale.fix=FALSE, data=ucb,@\\
\mbox{}\verb@                    family=binomial, corstr="exch") }  @\\
\mbox{}\verb@  else if (scale.method=="trend"){@\\
\mbox{}\verb@    geemod <- geepack::geese(Resp~unclass(Trt), sformula=~unclass(Trt), id=ucb$ID,  data=ucb,@\\
\mbox{}\verb@                   family=binomial, sca.link="log", corstr="exch")}@\\
\mbox{}\verb@  else if (scale.method=="all"){@\\
\mbox{}\verb@    geemod <- geepack::geese(Resp~unclass(Trt), id=ucb$ID,  sformula=~Trt, data=ucb,@\\
\mbox{}\verb@                    family=binomial, sca.link="log", corstr="exch") } @\\
